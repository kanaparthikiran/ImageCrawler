...
public class ImageTestDFSThreads {
	...
	private static final String CLASS_NAME="ImageTestDFSThreads";
	private static final String homePage = ImageCrawlerPropertyUtil
			.getProperty("homePage");
	private static final long heartBeatCheckTime = ImageCrawlerPropertyUtil.getIntProperty("sleepTime10Mins");
	private static final long lastBeatCheckTime = ImageCrawlerPropertyUtil.getIntProperty("sleepTime20Mins");
	/**
	 * 
	 */
	 ...
	 */
	public static void startCrawling(String className,String startPage,Logger log,String homePage,long heartBeatCheckTime,long lastBeatCheckTime) 
										throws IOException, InterruptedException {
		log.info("STARTED "+className);

		List<String> blankImageCheckSumList = ImagePatternCheckSum
				.getBlankImageCheckSumList();
		ScannerThread prod = new ScannerThread(queue, startPage,log,homePage);
		...
		shutDownThreads(prodThread,consThread,writers,heartBeatCheckTime,lastBeatCheckTime);
	}
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		startCrawling(CLASS_NAME,startPage,log,homePage,
				heartBeatCheckTime,lastBeatCheckTime);
	}
		 ...
		 * @throws InterruptedException
		 */
		public static void shutDownThreads(Thread prodThread,Thread consumerThread,List<Closeable >writers,long heartBeatCheckTime,long lastBeatCheckTime) 
						throws InterruptedException {
			while(true) {
				Thread.sleep(heartBeatCheckTime);
				...
				if(!prodThread.isAlive()) {
					...
					if(queueElem==null) { 
						...
						Thread.sleep(lastBeatCheckTime);
				}
				if(termCounter>=3) {
...
// * 
// */
//class ConsumerThreadInner implements Runnable {
//
...
//	 * @param consumerQueue
//	 */
//	ConsumerThreadInner(BlockingQueue<Map<String, Set<String>>> consumerQueue,
